...
package io.github.ghosthack.seven.internal.commons.compress.compressors.deflate64;

import static io.github.ghosthack.seven.internal.commons.compress.compressors.deflate64.HuffmanState.DYNAMIC_CODES;
import static io.github.ghosthack.seven.internal.commons.compress.compressors.deflate64.HuffmanState.FIXED_CODES;
import static io.github.ghosthack.seven.internal.commons.compress.compressors.deflate64.HuffmanState.INITIAL;
import static io.github.ghosthack.seven.internal.commons.compress.compressors.deflate64.HuffmanState.STORED;
...
import io.github.ghosthack.seven.internal.commons.compress.utils.BitInputStream;
        ...
        private int decodeNext(final byte[] b, final int off, final int len) throws IOException {
            ...
            while (result < len) {
                ...
                if (symbol < 256) {
                    ...
                    run =
                            Math.toIntExact(
                                    Math.addExact((long) run, readBits(runXtra)));
                    ...
                    dist =
                            Math.toIntExact(
                                    Math.addExact((long) dist, readBits(distXtra)));
