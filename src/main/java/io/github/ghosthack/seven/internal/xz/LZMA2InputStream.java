...
import io.github.ghosthack.seven.internal.xz.rangecoder.RangeDecoderFromBuffer;
...
public class LZMA2InputStream extends InputStream {
     ...
     *                          in the range [{@code DICT_SIZE_MIN},
     *                          {@code DICT_SIZE_MAX}]
     *
    ...
    /** Creates a raw LZMA2 decoder with the dictionary size stored by 7z. */
    public LZMA2InputStream(InputStream in, int dictSize) {
        if (in == null) {
            throw new NullPointerException("in");
        }
        this.arrayCache = ArrayCache.getInstance();
     ...
     * the {@code available()} method of the underlying InputStream.
     *
