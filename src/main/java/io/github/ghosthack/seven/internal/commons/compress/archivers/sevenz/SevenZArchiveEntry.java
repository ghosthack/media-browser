...
public class SevenZArchiveEntry {
    ...
    private long crc;
    private long size;
    private List<SevenZMethod> contentMethods = List.of();
     ...
     * @since 1.8
     */
    public List<SevenZMethod> getContentMethods() {
    ...
    public void setAccessDate(final long ntfsAccessDate) {
        this.accessDate = NtfsTime.ntfsTimeToFileTime(ntfsAccessDate);
    }
    ...
    /** Stores the decoder chain derived from the entry's folder. */
    public void setContentMethods(final List<SevenZMethod> methods) {
        contentMethods = List.copyOf(methods);
    }
    ...
    public void setCreationDate(final long ntfsCreationDate) {
        this.creationDate = NtfsTime.ntfsTimeToFileTime(ntfsCreationDate);
    }
    ...
    public void setLastModifiedDate(final long ntfsLastModifiedDate) {
        this.lastModifiedDate = NtfsTime.ntfsTimeToFileTime(ntfsLastModifiedDate);
    }
