...
package io.github.ghosthack.seven.internal.commons.compress.utils;
...
import io.github.ghosthack.seven.internal.commons.compress.archivers.sevenz.BoundedInputStream;
...
public class BitInputStream implements Closeable {
    ...
    public BitInputStream(final InputStream in, final ByteOrder byteOrder) {
        this.in = new BoundedInputStream(in, -1, true);
