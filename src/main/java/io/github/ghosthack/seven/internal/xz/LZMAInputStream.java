...
import io.github.ghosthack.seven.internal.xz.lz.LZDecoder;
import io.github.ghosthack.seven.internal.xz.rangecoder.RangeDecoderFromStream;
import io.github.ghosthack.seven.internal.xz.lzma.LZMADecoder;
...
public class LZMAInputStream extends InputStream {
    ...
    public LZMAInputStream(InputStream in, long uncompSize, byte propsByte,
        ...
        initialize(in, uncompSize, propsByte, dictSize, ArrayCache.getInstance());
    }

    private void initialize(InputStream in, long uncompSize, byte propsByte,
                            int dictSize, ArrayCache arrayCache)
            throws IOException {
        ...
        initialize(in, uncompSize, lc, lp, pb, dictSize, arrayCache);
    }
    ...
    private void initialize(InputStream in, long uncompSize,
        ...
        lz = new LZDecoder(getDictSize(dictSize), arrayCache);
