 ...
 * {@link Archive}, it can be {@link #close() closed} to wipe its own copy.
 *
 * @see Archive#Archive(io.github.ghosthack.unrar.internal.junrar.volume.VolumeManager, ArchiveOptions)
 */
public final class ArchiveOptions implements AutoCloseable {
    ...
    public static final int DEFAULT_MAX_HEADERS = 1_000_000;
    ...
    /** Wipes the password copy owned by this options instance. */
    @Override
    public void close() {
    ...
    public static final class Builder {
        ...
        /** Limits retained archive headers, including non-file service blocks. */
        public Builder maxHeaders(final int maxHeaders) {
        ...
        public ArchiveOptions build() {
            ...
            if (this.maxHeaders <= 0) {
                throw new IllegalArgumentException(
                        "maxHeaders must be > 0, was " + this.maxHeaders);
            }
